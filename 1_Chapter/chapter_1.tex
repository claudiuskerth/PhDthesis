\documentclass[a4paper,12pt,times,print,index,oneside,custommargin]{PhDThesisPSnPDF}\usepackage[]{graphicx}\usepackage[]{color}
...
\begin{itemize}
\item the history of the hybrid
\item RAD technology
\item population genomics with low coverage sequencing and without genotype calling
\item an analytical discussion of the related findings to date
\item description of the aims of the research
\end{itemize}
}
