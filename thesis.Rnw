...
\documentclass[a4paper,12pt,times,authoryear,twoside,print,index]{Classes/PhDThesisPSnPDF}
...
%%%%%% -- KNITR SETUP -- %%%%%%%%%%%%%%%%%%%%
<<setup_main, include=FALSE, cache=FALSE>>=
library(knitr)
# set global chunk options
opts_chunk$set(fig.path='Figs/Knitr/', fig.align='center', fig.show='hold', warning=FALSE)
...
<<chapter3, child='3_Chapter/chapter3.Rnw'>>=
@
<<chapter2, child='2_Chapter/chapter_2.Rnw'>>=
@
