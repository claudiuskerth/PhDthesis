...
\newglossaryentry{saf}{name=sample allele frequency, description={The sample allele frequency is the frequency of the allele among the individuals in a specific sample}}
...
\newglossaryentry{complexity reduction}{name=complexity reduction, description={here: reduction of the number of loci represented in a sequencing library}}


%----------------
% Acronyms
%----------------
\newacronym{DMI}{DMI}{Dobzhansky-Muller incompatibility}
\newacronym{GWAS}{GWAS}{genome wide association study}
\newacronym{kya}{kya}{thousand years ago}
...
\newacronym{BP}{BP}{before present}
